...
describe Monkey do
  ...
  it "can introduce itself with name, species, and foods eaten" do
    liza = Monkey.new("Liza", "Dusky Leaf Monkey")
    liza.eat("cheeseburger")
    liza.eat("bacon")

    expect(liza.introduce).to include("Liza")
    expect(liza.introduce).to include("Dusky Leaf Monkey")
    expect(liza.introduce).to include("cheeseburger")
    expect(liza.introduce).to include("bacon")
  end
  ...
  # end
  #
  # it "won't eat foods beginning with a vowel" do
  #   robin = Monkey.new("robin", "Olive Baboon")
  #
  #   robin.eat("apple")
  #   robin.eat("eclair")
